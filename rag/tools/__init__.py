...
from rag.tools.options import TOOL_DEFINITIONS as OPTIONS_TOOL_DEFINITIONS
from rag.tools.options import TOOL_DISPATCH as OPTIONS_TOOL_DISPATCH
...
from rag.tools.analytics import TOOL_DEFINITIONS as ANALYTICS_TOOL_DEFINITIONS
from rag.tools.analytics import TOOL_DISPATCH as ANALYTICS_TOOL_DISPATCH
from rag.tools.news import TOOL_DEFINITIONS as NEWS_TOOL_DEFINITIONS
from rag.tools.news import TOOL_DISPATCH as NEWS_TOOL_DISPATCH

# Aggregate all
ALL_TOOL_DEFINITIONS = (
    MARKET_TOOL_DEFINITIONS
    + OPTIONS_TOOL_DEFINITIONS
    ...
    + NEWS_TOOL_DEFINITIONS
)

ALL_TOOL_DISPATCH = {
    **MARKET_TOOL_DISPATCH,
    **OPTIONS_TOOL_DISPATCH,
