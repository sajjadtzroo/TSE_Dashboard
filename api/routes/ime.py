...
@handle_api_errors("Failed to fetch IME options")
def get_ime_options(
...
@handle_api_errors("Failed to fetch IME futures")
def get_ime_futures(
    limit: int | None = Query(default=None, ge=1, le=5000),
    db: Session = Depends(get_db),
):
...
@handle_api_errors("Failed to fetch IME certificates")
...
@handle_api_errors("Failed to fetch IME funds")
def get_ime_funds(
    date: _dt.date | None = None,
    limit: int | None = Query(default=None, ge=1, le=5000),
    db: Session = Depends(get_db),
...
@handle_api_errors("Failed to fetch IME forwards")
...
@handle_api_errors("Failed to fetch IME physical trades")
