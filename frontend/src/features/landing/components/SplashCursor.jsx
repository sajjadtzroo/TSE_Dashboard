 ...
 * Colors are drawn from the Rally design-system palette (hex → normalized float).
 * Source: https://www.reactbits.dev/animations/splash-cursor
 */
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    const RALLY_PALETTE = [
      { r: 0.161 * 0.15, g: 0.384 * 0.15, b: 1.0 * 0.15 },   // #2962FF blue
    ...
    // Pick a random color from the Rally palette (pre-multiplied by 0.15 for subtlety)
    function generateColor() {
      const c = RALLY_PALETTE[Math.floor(Math.random() * RALLY_PALETTE.length)];
