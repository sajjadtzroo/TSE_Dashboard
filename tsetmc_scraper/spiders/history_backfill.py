...
class HistoryBackfillSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for ins_code, symbol, sec_id in securities:
            url = f'https://BrsApi.ir/Api/Tsetmc/History.php?key={api_key}&id={ins_code}'
        ...
        for rec in data:
            try:
                ...
                if pcp is not None:
                    ...
                    item['close_change_pct'] = round(((close - yesterday) / yesterday) * 100, 2)
    ...
    def closed(self, reason):
        ...
        logger.info(f"Total: {self.total_records} new records across {self.total_instruments} instruments")
