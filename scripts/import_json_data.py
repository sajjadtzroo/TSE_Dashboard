        ...
        for i, stock in enumerate(stocks, 1):
            try:
                ...
                price = (
                    ...
                    .filter_by(ins_code=ins_code, d_even=today)
                    .first()
                )
                ...
                if not price:
                    price = DailyPrice(
                        ...
                        price_first=stock.get(
                            "latest_price"
                        ),  # Not ideal mapping but OK for testing
...
def verify_import():
    ...
    with db.get_session() as session:
        ...
        stocks = (
            ...
            .filter(Company.ins_code < 2000000000000000)  # Stocks have lower InsCodes
            .limit(5)
            .all()
        )
        ...
        funds = (
            ...
            .filter(Company.ins_code >= 2000000000000000)  # Funds have higher InsCodes
            .limit(5)
            .all()
        )
